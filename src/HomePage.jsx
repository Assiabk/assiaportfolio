    ...
    <div className="relative bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white font-sans min-h-screen overflow-x-hidden">
      ...
      <Particles
        ...
        options={{
          ...
          interactivity: {
            events: {
              onHover: { enable: true, mode: "bubble", parallax: { enable: true, force: 30 } }
            }
          },
          particles: {
            ...
            opacity: { animation: { enable: true, speed: 0.5 } }
          }
        }}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: "A minimalist photography portfolio to showcase beautiful visual stories and shots.",
              tech: ["React", "Tailwind CSS"],
            ...
            >
              <div className={`absolute -top-10 -right-10 w-32 h-32 rounded-full bg-gradient-to-br ${color} opacity-20 group-hover:opacity-30 transition-opacity duration-500`}/>
              ...
              <div className="absolute inset-0 shadow-[0_0_30px_-10px_rgba(168,85,247,0.3)] opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>
            </motion.div>
          ))}
        </div>
      </section>
...
<section className="py-20 px-8 max-w-6xl mx-auto">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {[
      {
        title: "Educ-App",
        desc: "application to study the hard calculation for kids students.",
      ...
      {
        title: "BK Services app",
        desc: "Mobile android app to hire local services in algeria",
        tech: ["Flutter", "BLoC", "Firebase"],
        color: "from-green-500 to-teal-600",
        link: "#",
 image: bookingAppMockup ,
        badge: "App Store"
      },
    ].map(({ title, desc, tech, color, link, image, badge }) => (
      <motion.div
        key={title}
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        {badge && (
          <span className={`absolute top-4 right-4 text-xs px-2 py-1 rounded-full bg-gradient-to-r ${color} text-white`}>
            {badge}
          </span>
        )}
        ...
        <div className="relative z-10">
          <div className="h-72 mb-6 rounded-lg overflow-hidden border border-gray-700 bg-black">
            <img
              src={image}
              alt={title}
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          ...
          <div className="flex justify-center gap-6">
            {[
              ...
              { icon: <FiInstagram />, url: "https://www.instagram.com/code_with_assia", color: "hover:text-pink-400" }
            ].map((item, i) => (
              <motion.a
                key={i}
                href={item.url}
